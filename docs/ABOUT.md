...
A dedicated module centralizes browser cache rules according to Jahia content URLs and ensures that it cannot be overwritten by other components. However, it is possible to customize behavior for some specific module's URLs using a specific ruleset.
